...
// ═══════════════════════════════════════════════
//  Button Labels  —  v10.4  (رنگی و آپدیت شده)
// ═══════════════════════════════════════════════
$buttonValues = [
    // ── پنل ادمین ──
    ...
    'gateways_settings'     => '💳 تنظیمات درگاه‌ها',
    'bot_settings'          => '⚙️ تنظیمات ربات',
    'tickets_list'          => '🎫 تیکت‌ها',
    'message_to_all'        => "📢 پیام همگانی",
    ...
    'nextpay_gateway'       => "🔵 نکست‌پی",
    'weswap_gateway'        => "🔄 ارزی ریالی (WeSwap)",
    'tron_gateway'          => "♦️ پرداخت ترون",
    'pay_with_wallet'       => "💰 پرداخت با کیف‌پول",
    'sharj'                 => "💳 شارژ کیف‌پول / ارسال رسید",
    ...
    // ── مدیریت کانفیگ ──
    'renew_connection_link'     => "🔗 لینک جدید (قطع دسترسی قبلی)",
    ...
    'qr_config'                 => "📷 QR Code کانفیگ",
    'qr_sub'                    => "📷 QR Code ساب‌لینک",

    // ── اقدامات کاربر ──
    'send_phone_number'     => '📱 ارسال شماره تلفن',
    'send_message_to_user'  => "✉️ ارسال پیام به کاربر",
    'join_channel'          => "📢 عضویت در کانال",
    'have_joined'           => "✅ عضو شدم",
    'test_account'          => "🎁 دریافت اکانت تست",
    'invite_friends'        => "👥 دعوت دوستان (زیرمجموعه)",
    'my_info'               => "👤 حساب کاربری من",
